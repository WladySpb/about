...
(function () {
  ...
  var T = {
    ...
    en: {
      ...
      projects_title: "Projects", group_ai: "AI & Gamedev", group_qsp: "Text Adventure Games",
      proj_masterclaw_desc: "Interactive AI Game Master — dynamic storytelling powered by artificial intelligence.",
      proj_increMemory_desc: "A new game currently in development.",
    ...
    sr: {
      ...
      projects_title: "Пројекти", group_ai: "АИ и Гejм дев", group_qsp: "Текстуалне авантуре",
      proj_masterclaw_desc: "Интерактивни АИ Гejм Мастер — динамичко приповедање засновано на вештачкој интелигенцији.",
      proj_increMemory_desc: "Игра у развоју.",
    ...
    uk: {
      ...
      projects_title: "Проекти", group_ai: "AI та геймдев", group_qsp: "Текстові ігри",
      proj_masterclaw_desc: "Інтерактивний AI Гейм Майстер — динамічний сторителінг на основі штучного інтелекту.",
      proj_increMemory_desc: "Гра у розробці.",
    ...
    ka: {
      ...
      projects_title: "პროექტები", group_ai: "AI და გეიმდევი", group_qsp: "ტექსტური თავგადასავლები",
      proj_masterclaw_desc: "ინტერაქტიული AI გეიმ მასტერი — დინამიური მოთხრობა ხელოვნური ინტელექტის საფუძველზე.",
      proj_increMemory_desc: "თამაში შექმნის პროცესშია.",
    ...
    he: {
      ...
      projects_title: "פרויקטים", group_ai: "AI ופיתוח משחקים", group_qsp: "משחקי הרפתקאות טקסט",
      proj_masterclaw_desc: "מאסטר משחק AI אינטראקטיבי — סיפור דינמי מבוסס בינה מלאכותית.",
      proj_increMemory_desc: "משחק הנמצא בפיתוח.",
