...
(function () {
  ...
  var T = {
    ...
    en: {
      ...
      proj_attic_desc: "An AI-driven fiction pipeline — I invent the plot, AI writes the script, story arcs, and prose.",
    ...
    ru: {
      ...
      proj_attic_desc: "Пайплайн историй на основе ИИ — я придумываю сюжет, ИИ пишет сценарий, арки и прозу.",
    ...
    sr: {
      ...
      proj_attic_desc: "АИ пајплајн за приче — ја смишљам заплет, АИ пише сценарио, наративне линије и прозу.",
    ...
    uk: {
      ...
      proj_attic_desc: "АІ-пайплайн для історій — я вигадую сюжет, ШІ пише сценарій, арки та прозу.",
    ...
    ka: {
      ...
      proj_attic_desc: "AI პაიფლაინი ისტორიებისთვის — მე ვქმნი სიუჟეტს, AI წერს სცენარს, არკებს და პროზას.",
    ...
    he: {
      ...
      proj_attic_desc: "צינור סיפורים מבוסס AI — אני יוצר את העלילה, ה-AI כותב את התסריט, קשתות עלילה ופרוזה.",
